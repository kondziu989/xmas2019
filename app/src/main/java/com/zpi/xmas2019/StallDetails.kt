...
class StallDetails : Fragment() {
    ...
    override fun onCreateView(
        ...
        var title = "Domek nr " + stall_nr
        stall_title.setText(title);
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(stall_nr: Int, tags: ArrayList<String>) =
            StallDetails().apply {
                arguments = Bundle().apply {
                    putInt(STALL_NR, stall_nr)

...
class HowToGetActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.menu_how_to_get, menu)
        return true
    }
    ...
    inner class SectionsPagerAdapter(fm: FragmentManager) : FragmentPagerAdapter(fm) {
        ...
        override fun getItem(position: Int): Fragment {
            when (position) {
                0 -> return HowToGetTram()
                1 -> return HowToGetBus()
                else -> return HowToGetCar()
            }
        }
